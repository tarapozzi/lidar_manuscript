...
Flooding is the most frequent and destructive natural disaster for humans due to our proximity to water sources and increasing population and urbanization rates [@pralleDrawingLinesFEMA2019; @schanzeFloodRiskManagement2006]. Floods are expected increase in frequency and severity due to climate change. This is true for the western United States where we can expect to see an increase in precipitation and higher temperatures earlier in the year [@clarkChangesPatternsStreamflow2010; @ralphVisionFutureObservations2014; @idahoofficeofemergencymanagementStateIdahoHazard2018; @washingtonemergencymanagementdivisionWashingtonStateEnhanced2020]. In response, many communities have adopted new technology and management practices to adaptively manage this increase in risk. One of those practices is using higher-resoultion topographic data to more accurately predict where flooding will occur. Accurate floodplain maps are essential for communicating flood risk to vulnerable populations, helping mitigate and adapt to floods, and the functioning of insurance programs, such as the the Federal Emergency Management Agency's National Flood Insurance Program [@pralleDrawingLinesFEMA2019]. Light Detection and Ranging (lidar) is a technology used to collect higher quality topographic data. Lidar is a laser-based remote sensing technology that uses light to measure elevation and features on the ground, providing high-quality and detailed topographic data. However, there has been variable adoption of lidar, especially in the western United States (stat about mapping?). This study asks why this variation exists and examines the role of risk in the process of decision-making towards adopting a new technology like lidar for long-term risk mitigation. 

Risk perception has been well studied, especially in terms of its role in how people make decisions regarding long-term hazardous activities and technologies [@slovicPerceptionRisk1987]. For example, past findings have suggested that higher risk perception is correlated with more cautious behavior in response to natural hazards [@vinhhungFloodRiskManagement2007]. However, previous studies have also identified an unexpected relationship between risk perception and lack of risk mitigating behavior named the “Risk Perception Paradox” [@bubeckReviewRiskPerceptions2012; @wachingerRiskPerceptionParadoxImplications2013]. This could be due to cultural and individual factors that intervene with risk perception. As a result, there has been a substantial body of research into the socio-cultural factors that could moderate the effect of risk perception on risk mitigating behavior [@baerenklauUnderstandingTechnologyAdoption2005; @birkholzRethinkingRelationshipFlood2014; @bubeckReviewRiskPerceptions2012; @kahanCultureIdentityProtectiveCognition2007; @vanvalkengoedMetaanalysesFactorsMotivating2019]. Lidar use in flood risk management provides an interesting case study because it has proven to be an effective technology for predicting floodplains and flood risk with higher accuracy than previous topographic data. However, the benefits of this technology have a variable reward and time delay, two key factors that can feel risky in adopting this technology.

Previous research lacks a theoretically-backed examination of flood risk [@kellensPerceptionCommunicationFlood2013a]. We will examine this variation through a risk-sensivity and behavioral ecology lens, which is the study of adaptive behavior in relation to social and environmental circumstances [@birdBehavioralEcologyArchaeology2006]. As a sub-field of evolutionary ecology, behavioral ecology applies natural selection theory to explain variation in adaptive behavior and consequently differential fitness outcomes [@smithEvolutionaryEcologyHuman1992]. While traditional theories of decision-making lack consideration of evolutionary processes, research in recent years has begun to incorporate behavioral ecology theory into decision-making under risk. This is because humans are the products of evolution by natural selection, therefore human decision-making is a product of evolutionary process as well [@mishraDecisionMakingRiskIntegrating2014]. 

We collected our data for this study through an online, structured survey instrument that measured predictors of risk-sensitivity, as well as additional social and environmental predictors for lidar use in Washington and Idaho. We then ran a Hierarchical Bayesian model for the estimation predictor effect size on lidar use with varying intercepts and slopes for Idaho and Washington. Finally, we discuss the implications of these results and need for further research. 
